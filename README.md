...
### Abdulattef  عبداللطيف 
 تصغيري خط الفوتر1. 
تعديل الاتتجاه لفئة قسم الانجليزي من اليسار الى اليمين2. 
...
### Fiadh
صراحة الخط حق المقالات حلو مرة
بس ليش ابتعدت من التصميم واللوان زيادة مثلا القائمة المنسدلة كلها ساع الروابط بس،،، وبرضه كان في تعليقات على المقالات مش موجود

### Esmat 
ل شيء على ما يرام، فقط ينقصه تحسين تجربة قابلية القراءة.
يعني أن الخط في المواضيع صغير.

### khaled alaffan 
حدثت الصفحة ومسحت الكاش على امل تحميل أي ملف css لتغيير الألوان الإفتراضية الظاهرة، أظنها تحتاج لتغيير إذا كانت هكذا، أيضاً حجم الخط صغير جداً عند فتح التدوينة
...
### Omar al-Majedi
أيقونة الرجوع إلى أعلى في الجوال اشوفها مرتفعه زيادة
...
- [ ] إضافة robots.txt
- [ ] إضافة Google Analytics
- [ ]  تعديل وسم الإعلانات بدلا من ad إلى شيء آخر لأنه يحذف من مانع الإعلانات
## تحسينات
